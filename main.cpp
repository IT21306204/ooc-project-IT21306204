...
int main() {
  RegisteredCustomer *r1 = new RegisteredCustomer(112456784,"surajZoory@yahoo.com","75A, raigama, Rajagiriya","1997/12/21");
  r1->displayRDetails();
  ...
  shopper *s1 = new shopper("SID33", 776576546, "sugathrajapaksa@gmail.com", "78/10, Nisala Pedasa, Mattegoda","2000/04/12");
  s1->displayRinfo();
  ...
  Designer *d1 = new Designer(769875678, "sithumiGuna@gmail.com", "33/b, upper jackson Road, Galle","2001/05/12", "DID02");
  d1->displayRDetails();
